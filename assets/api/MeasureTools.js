...
], function (dom, declare, lang,_WidgetBase, on,
             Graphic, GraphicsLayer, Draw, Color, Font, Polyline, MarkerSymbol, LineSymbol, TextSymbol, geometryEngine) {
    var measureTools = declare(_WidgetBase, {
        declaredClass: 'MeasureTools',
        defaults: {
            map: null,
        ...
        _initalToolbar: function () {
            ...
            this.toolbar = new Draw(map, {tooltipOffset: 20, drawTime: 75});
